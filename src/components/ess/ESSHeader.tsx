...
const notifications = [
  ...
  {
    id: 2,
    title: "New message from HR Department",
    time: "Today, 7:51 AM",
    icon: MessageSquare,
    iconBg: "bg-primary",
  },
  {
    id: 3,
    title: "Reminder: Submit your timesheet by Friday",
          ...
          <DropdownMenuContent align="end" className="w-64 bg-card border-border">
            ...
            <div className="flex items-center gap-3 p-3">
              ...
              <div className="flex flex-col">
                ...
                <Link to="/login" className="text-xs text-primary cursor-pointer hover:underline">Sign Out</Link>
              </div>
            </div>
            <DropdownMenuSeparator />
            ...
            <DropdownMenuItem onClick={() => navigate("/ess/payslips")}>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => navigate("/ess/tickets")}>
