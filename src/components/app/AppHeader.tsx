          ...
          <DropdownMenuContent align="end" className="w-64 bg-card border-border">
            ...
            <div className="flex items-center gap-3 p-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-primary">{currentRole?.name}</span>
              </div>
            </div>
            <DropdownMenuSeparator />
            ...
            <DropdownMenuItem onClick={() => navigate("/app/settings/personal")}>
              <Settings className="mr-2 h-4 w-4" />
              Settings
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => navigate("/app/support/new")}>
