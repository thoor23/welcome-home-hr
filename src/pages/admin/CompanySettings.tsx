          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              <TabsList className="grid w-full grid-cols-4 lg:grid-cols-8 h-auto gap-1">
                ...
                <TabsTrigger value="localization" className="flex items-center gap-2 text-xs">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="passwordHistory" type="number" defaultValue="5" min={0} max={20} />
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between py-2">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">Allow users to be logged in from multiple devices</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    <div className="flex items-center justify-between py-2">
