  ...
  return (
    <AdminLayout>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground font-display">All Assets</h1>
          <p className="text-muted-foreground mt-1">Manage your organization's asset inventory</p>
        </div>
